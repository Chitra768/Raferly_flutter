class ModelReferralList {
  int? code;
  bool? status;
  String? message;
  List<ReferrelData>? data;

  ModelReferralList({this.code, this.status, this.message, this.data});

  ModelReferralList.fromJson(Map<String, dynamic> json) {
     List<ReferrelData> parsedData = [];
      if (json['data'] is List) {
      parsedData = (json['data'] as List)
          .map((item) => ReferrelData.fromJson(item))
          .toList();
    } else if (json['data'] is String && json['data'].toString().trim().isEmpty) {
      parsedData = [];
    }
    code = json['code'];
    status = json['status'];
...
class ReferrelData {
  ...
  ReferrelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Roles {
  ...
  Roles.fromJson(Map<String, dynamic> json) {
    ...
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    pivot = json['pivot'] != String ? new Pivot.fromJson(json['pivot']) : null;
  }
