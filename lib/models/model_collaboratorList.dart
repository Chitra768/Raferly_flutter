class CollaboratorListModel {
  ...
  bool? status;
  String? message;
  List<CoworkerlistData>? data;

  CollaboratorListModel({this.code, this.status, this.message, this.data});

  CollaboratorListModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <CoworkerlistData>[];
      json['data'].forEach((v) {
        data!.add(new CoworkerlistData.fromJson(v));
      });
    }
  }
...
class CoworkerlistData {
  ...
  CoworkerlistData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    dealId = json['deal_id'];
    userId = json['user_id'];
