...
final Map<String, String> en = {
  ...
  LanguageKeys.BottomText:
    'Upgrate to premium now to unlock these feature 🔒',
  ...
  LanguageKeys.consultingDescription: 'Get personalized guidance from our networking experts to expand your professional connections and accelerate your career growth.',
  ...
  LanguageKeys.professional: 'Professional',
  LanguageKeys.individual: 'Individual',
  LanguageKeys.professionalDescription: 'For businesses and organizations. Create a professional profile to showcase your company, services, and team. Ideal for B2B networking and corporate partnerships.',
  LanguageKeys.individualDescription: 'For personal use. Create an individual profile to connect with professionals, find opportunities, and grow your personal network.',
  // LanguageKeys.continue: 'Continue',
  LanguageKeys.Areyouaprofessional: 'Are youa professional',
  LanguageKeys.networkWithProfessionals: 'Network with other professionals via Referaly',
  LanguageKeys.findBusinessReferrers: 'Find business referrers for your business',
  LanguageKeys.alsoReferThem: 'Also refer them',
  LanguageKeys.connectedCardDescription: 'A connected card that you tap on the phone, easy and fast',
  LanguageKeys.digitalVisitCard: 'A digital visit card for your leads, clients and partners',
  LanguageKeys.bestNetworkingTool: 'Your best networking tool !!',
  LanguageKeys.standOutDifferent: 'Stand out, be different and order your card now',
  ...
  LanguageKeys.successMessage: "We'll get back to you with business referrers and potential partners.",
  LanguageKeys.consultationNote: "We'll also cover this during your consultation call.",
