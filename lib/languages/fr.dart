...
// welcome page
LanguageKeys.Welcome: 'Bienvenue',
...
LanguageKeys.createAnAccount: 'Se créer un compte en 2 secondes',
LanguageKeys.createAnAccountSignIn: 'Se connecter 2 secondes',
//intro sliders
...
// register page
LanguageKeys.register: 'Se Connecter',
...
//forgot password
LanguageKeys.forgotPassword2: 'Mot de passe oublié?',
...
LanguageKeys.getrecomget: 'Plus d’apporteurs d’affaires,', // Changed After 15th July Doc Shared 'Plus Réseau d’Affaires,',
LanguageKeys.morelead: 'Plus de Clients',
LanguageKeys.creatNmanageyournetwork: 'Créez et gérez votre réseau',
LanguageKeys.bussinessreferrence: "Réseau d'apporteurs d'affaires",
...
LanguageKeys.activeDeal: 'Récents',
...
'Suivi automatisé de vos dossiers clients',
...
LanguageKeys.commissionReceived: 'Commissions reçues', // Changed After Feedback of 15th July Doc Shared 'Commission(S) reçues', //'Prospects envoyés',
...
LanguageKeys.agreeAndAccept:
'J’ai lu et j’accepte les conditions du contrat',
LanguageKeys.new_deal: 'Votre mission d’apport d’affaires',
LanguageKeys.leadSubmissionForm: 'Envoyer un prospect',
LanguageKeys.submitLead: 'Envoyer un prospect',
...
LanguageKeys.createYourFirst: 'Créer votre premier programme partenaire',
LanguageKeys.createButton: 'créer',
LanguageKeys.becomeABusiness:
'Devenez apporteurs d’affaires pour des entreprises',
...
LanguageKeys.editLead: 'Modifier le contact',
...
LanguageKeys.dealTabHeader: 'Programmes invités',
...
LanguageKeys.enterDescriptionErr: 'Veuillez entrer une description',
...
LanguageKeys.createAnAccount: 'Se créer un compte en 2 secondes',
LanguageKeys.createAnAccountSignIn: 'Se connecter 2 secondes',
LanguageKeys.archive: 'Historique',
...
LanguageKeys.finderDescriptionField:
'Description du besoin de votre contact',
...
LanguageKeys.dealSelector: 'Ajouter vos collègues de travail',
LanguageKeys.specificDeal: 'Partager l’accès à',
LanguageKeys.allDeals: 'Tous les contrats',
LanguageKeys.uniqueCommision: 'Commission Unique',
LanguageKeys.differentCommision: 'Différentes commissions',
...
LanguageKeys.percentage_CommissionV1: 'Commission au %',
...
'Cliquez ici pour voir le contrat complet',
...
LanguageKeys.deleteIamReferrer: 'Quitter',
...
LanguageKeys.outOf: 'Envoyez un prospect',
LanguageKeys.sendLeadOut: 'Send Out of Referaly',
LanguageKeys.sendLead: 'Envoyer un prospect',
LanguageKeys.outOfReferalyInfo:
'Envoyer un prospect à un professionnel qui n’a pas encore Referaly. \n Soyez protégé par un contrat et bénéficiez d’un suivi transparent ! \n Les informations de votre prospect ne seront pas partagé tant que le contrat n’a pas été accepté.',
...
"à un professionnel qui a ou qui n'a pas Referaly",
...
'Coaching avec un\nexpert du networking',
LanguageKeys.Howitworks: 'Comment ça\nmarche?',
...
LanguageKeys.inviteReferalyIconText: "M'a déjà invité sur Referaly",
LanguageKeys.inviteSendText: "ne m'a pas invité sur Referaly",
...
LanguageKeys.ReferalyConnectedCard: 'Carte connectée\nReferaly',
...
LanguageKeys.consultingDescription: 'Obtenez des conseils personnalisés de nos experts en réseautage pour élargir vos connexions professionnelles et accélérer votre croissance de carrière.',
...
LanguageKeys.editProfileCompanyInfo: 'Modifier le profil et les informations de l\'entreprise',
...
LanguageKeys.professional: 'Professionnel',
LanguageKeys.individual: 'Individuel',
LanguageKeys.professionalDescription: 'Pour les entreprises et organisations. Créez un profil professionnel pour présenter votre société, services et équipe. Idéal pour le réseautage B2B et les partenariats d\'entreprise.',
LanguageKeys.individualDescription: 'Pour usage personnel. Créez un profil individuel pour connecter avec des professionnels, trouver des opportunités et développer votre réseau personnel.',
// LanguageKeys.continue: 'Continuer',
LanguageKeys.Areyouaprofessional: 'Êtes-vous un professionnel ?',
LanguageKeys.networkWithProfessionals: 'Réseauter avec d\'autres professionnels via Referaly',
LanguageKeys.findBusinessReferrers: 'Trouvez des recommandateurs d\'affaires pour votre entreprise',
LanguageKeys.alsoReferThem: 'Recommandez-les également',
LanguageKeys.connectedCardDescription: 'Une carte connectée que vous tapez sur le téléphone, facile et rapide',
LanguageKeys.digitalVisitCard: 'Une carte de visite numérique pour vos prospects, clients et partenaires',
LanguageKeys.bestNetworkingTool: 'Votre meilleur outil de réseautage !!',
LanguageKeys.standOutDifferent: 'Démarquez-vous, soyez différent et commandez votre carte maintenant',
...
LanguageKeys.successMessage: 'Nous vous recontacterons avec des recommandateurs et partenaires potentiels.',
LanguageKeys.consultationNote: 'Nous aborderons également cela lors de votre appel de consultation.',
LanguageKeys.bookConsultationButton: 'Réserver ma consultation',
LanguageKeys.businessReferrerFeatures: 'Fonctionnalités du Recommandeur',
LanguageKeys.sendLead: 'Envoyer un prospect',
...
LanguageKeys.bookConsultation: 'Réserver une consultation',
LanguageKeys.alreadyHaveCard: 'J\'ai déjà une carte',
LanguageKeys.orderCard: 'Commander une carte',
