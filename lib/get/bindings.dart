...
export 'package:referaly/bindings/lead_tracking_binding.dart';
...
class BindingBusinessReferrerContract extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<BusinessReferrerContractController>(
        () => BusinessReferrerContractController());
  }
}
