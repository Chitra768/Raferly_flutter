  ...
  Widget _quickActionsSection(TeamMemberProfileModel profile) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        _quickActionTile(
          title: tr(LanguageKeys.teamMemberProfileViewAllLeads),
        ...
        const SizedBox(height: 12),
        _quickActionTile(
          title: tr(LanguageKeys.teamMemberProfileBusinessReferrers),
          subtitle: tr(LanguageKeys.teamMemberProfileViewReferrersSubtitle),
          icon: Icons.groups_outlined,
          highlighted: false,
          onTap: () => controller.openContent(TeamMemberContentTab.referrers),
        ),
        const SizedBox(height: 12),
        _quickActionTile(
          title: tr(LanguageKeys.teamMemberProfileReferralAgreements),
          subtitle: tr(LanguageKeys.teamMemberProfileAgreementsSubtitle),
          icon: Icons.description_outlined,
          highlighted: true,
          onTap: () => controller.openContent(TeamMemberContentTab.contracts),
        ),
      ],
    );
  }
