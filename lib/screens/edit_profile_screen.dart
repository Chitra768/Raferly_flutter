...
class EditProfileScreen extends StatelessWidget {
                    ...
                    child: ElevatedButton(
                      ...
                      child: Obx(
                        () => Text(tr(LanguageKeys.okay),
                            textAlign: TextAlign.center, style: stylePoppins(color: AppColors.whiteColor)),
                      ),
                    ),
                  ),
                ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: _inputDecoration(tr(LanguageKeys.email)),
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              hintText: tr(LanguageKeys.phoneNumber),
                                    ...
                                    children: [
                                      Expanded(
                                        child: RadioListTile<String>(
                                          ...
                                          groupValue: controller.userType.value == "professional"
                                              ? tr(LanguageKeys.professional)
                                              : tr(LanguageKeys.individual),
                                          onChanged: (val) {
                                            AppHelper.showLog("asfsfs: $val");
                                            if (val == tr(LanguageKeys.professional)) {
                                              controller.isEditUserType.value = true;
                                            } else {
                                              controller.isEditUserType.value = false;
                                            }
                                        ...
                                        child: RadioListTile<String>(
                                          ...
                                          onChanged: (val) {
                                            if (val == tr(LanguageKeys.individual) &&
                                                _isIndividualSwitchBlocked(controller)) {
                                              _showCannotDowngradeDialog(context);
                                              return;
                                            }
                                            controller.setUserType(val!);
                                          },
                              ...
                              _buildLabel(tr(LanguageKeys.job),
                                  isRequired: controller.userType.value == "professional"),
                              const SizedBox(height: 8),
                              TextFormField(
                                controller: controller.jobController,
                                decoration: _inputDecoration(tr(LanguageKeys.job)),
                                validator: (value) {
                              ...
                              TextFormField(
                                ...
                                decoration: _inputDecoration(tr(LanguageKeys.city)),
                                validator: (value) =>
                                    value == null || value.isEmpty ? tr(LanguageKeys.pleaseEnterCity) : null,
                              ),
                              const SizedBox(height: 16),
                              _buildLabel(
                                tr(
  ...
  void showImagePickerSheet(BuildContext context, VoidCallback onCamera, VoidCallback onGallery) {
