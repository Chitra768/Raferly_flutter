...
class MyProfileCopyScreen extends StatefulWidget {
  static const pageId = '/myProfile';

  const MyProfileCopyScreen({super.key});

  @override
  State<MyProfileCopyScreen> createState() => _MyProfileScreenState();
}

class _MyProfileScreenState extends State<MyProfileCopyScreen> {
