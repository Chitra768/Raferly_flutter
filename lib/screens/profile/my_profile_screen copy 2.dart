...
class MyProfileScreenCopy extends StatefulWidget {
  static const pageId = '/myProfile';

  const MyProfileScreenCopy({super.key});

  @override
  State<MyProfileScreenCopy> createState() => _MyProfileScreenState();
}

class _MyProfileScreenState extends State<MyProfileScreenCopy> {
