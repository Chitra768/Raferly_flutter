              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Obx(() {
                    ...
                    final coworkerRef = ref as BusinessReferrers;
                    avatar = coworkerRef.avatarUrl;
                    fullName =
                        "${coworkerRef.firstName ?? ''} ${coworkerRef.lastName ?? ''}"
                            .trim();
                    phoneNumber = coworkerRef.phoneNumber;
                    email = coworkerRef.email;
                    createdAt = coworkerRef.createdAt.toString();
