...
echo ""
print_info "Cache cleanup completed successfully!"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    print_info "iOS build location: build/ios/archive/Runner.xcarchive"
else
    print_error "Failed to build iOS"
    exit 1
fi
...
echo "iOS Archive: build/ios/archive/Runner.xcarchive"
echo ""
